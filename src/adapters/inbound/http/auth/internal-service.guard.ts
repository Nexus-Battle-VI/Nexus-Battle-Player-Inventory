...
import { INTERNAL_CALLERS, IS_INTERNAL } from './decorators'
...
export class InternalServiceGuard implements CanActivate {
  ...
  canActivate(context: ExecutionContext): boolean {
    ...
    const callers =
      this.options.reflector.getAllAndOverride<readonly string[] | undefined>(INTERNAL_CALLERS, [
        context.getHandler(),
        context.getClass(),
      ]) ?? this.options.allowedServices
    if (!callers.includes(service)) {
